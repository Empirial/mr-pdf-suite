...
import { ArrowLeft, FileText, Download, Loader2, FileType } from "lucide-react";
...
const WordToPdf = () => {
  ...
  const convertFile = async () => {
    ...
    try {
      ...
      toast({ title: "Success", description: "Word converted to PDF successfully!" });
    } catch (error: any) {
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-foreground">Word to PDF</h1>
                <p className="text-sm text-muted-foreground">Convert DOCX to PDF</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto">
          {!file ? (
            ...
            >
              <FileType className="h-16 w-16 mx-auto text-muted-foreground mb-4" />
