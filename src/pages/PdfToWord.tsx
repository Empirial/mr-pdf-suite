...
import { ArrowLeft, FileType, Download, Loader2, FileText, AlertCircle } from "lucide-react";
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-foreground">PDF to Word</h1>
                <p className="text-sm text-muted-foreground">Convert PDF to editable DOCX</p>
              </div>
            </div>
          </div>
        </div>
