import { Upload, ArrowDownUp, Download, Combine, Camera, PenTool, FileImage } from "lucide-react";
...
const tools = [
  ...
  },
  {
    ...
    description: "Capture photos and save them as PDF",
    icon: <Camera className="h-6 w-6 text-primary" />,
    href: "/scan",
  },
  {
    title: "Sign PDF",
    description: "Add your digital signature to any PDF",
    icon: <PenTool className="h-6 w-6 text-primary" />,
    href: "/sign",
  },
  {
    title: "File Converter",
    description: "Convert images and text to PDF format",
